...
var cpuData = [
    ...
    ['', '', '', '', '', '', '', '麒麟980', '', '', ''],
    ['', '', '', '', '骁龙845', 'Exynos 9810', '', '', '', '', ''],
    ['', '', '', '骁龙765/765G', '', '', '', '麒麟810', 'A11', '', ''],
    ['', '', '', '骁龙730/730G', '骁龙835', 'Exynos 8895', 'Helio G90T', '麒麟970', '', '', ''],
    ['', '', '', '', '', '', '', '', 'A10', '', ''],
    ['', '', '', '骁龙712', '', '', '', '', 'A9X', '', ''],
    ['', '', '', '骁龙710', '', '', '', '麒麟960', '', '', ''],
    ...
    ['', '', '', '', '', '', '', '麒麟950', '', '', ''],
    ['', '', '', '', '骁龙810', 'Exynos 7420', 'Helio X25', '', 'A8X', '', ''],
    ['', '', '', '', '', '', 'Helio X23', '', '', '', ''],
    ['', '', '', '骁龙653', '', '', 'Helio X20', '', '', '', ''],
    ['', '', '', '', '', '', '', '', 'A8', '', ''],
    ['', '', '', '骁龙652/636', '', '', '', '', '', '', 'Tegra X1'],
    ...
    ['', '', '', '骁龙625', '骁龙801<br/>(MSM8x74AC)', 'Exynos 5430', 'Helio P23/X10', '', '', 'Z3590', ''],
    ...
    ['', '', '', '', '', 'Exynos 5430', '', '', '', 'Z3530', ''],
    ['', '', '', '', '', 'Exynos 5422', '', '麒麟620', '', '', ''],
    ['', '', '骁龙435', '骁龙617', '骁龙800', 'Exynos 5420', 'MT6595/T', '麒麟928', 'A7', 'Z3480', 'Tegra 4'],
    ['', '', '骁龙430', '骁龙616', '', 'Exynos 5410', 'MT6592', '麒麟925', '', 'Z3460', ''],
    ['', '', '骁龙427', '骁龙615', '', '', '', '麒麟920', '', '', 'Tegra 4i'],
    ['APQ8064', '', '骁龙425', '骁龙600', '', 'Exynos 5260', 'MT6582', 'K3V2+<br/>(麒麟910)', '', '', ''],
    ['', '', '', '', '', '', '', '', '', 'Z3580', ''],
    ['', '骁龙212', '', '骁龙610', '', '', '', '', '', '', ''],
...
try {
    ...
    // 背景高亮
    const specialCPU = ['骁龙439', '骁龙765', '骁龙665']
