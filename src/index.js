...
var cpuData = [
    ...
    ['', '', '', '', '', '', '', '麒麟980', '', '', ''],
    ['', '', '', '', '骁龙845', 'Exynos 9810', '', '', '', '', ''],
    ['', '', '', '骁龙765/765G', '', '', 'Helio G90T', '麒麟810', 'A11', '', ''],
    ['', '', '', '骁龙730/730G', '骁龙835', 'Exynos 8895', '', '麒麟970', '', '', ''],
    ['', '', '', '', '', '', '', '', 'A10', '', ''],
    ['', '', '', '骁龙712', '', '', '', '', 'A9X', '', ''],
    ['', '', '', '骁龙710', '', '', '', '麒麟960', '', '', ''],
    ...
    ['', '', '', '骁龙636', '', '', '', '麒麟950', '', '', ''],
    ['', '', '', '骁龙630', '骁龙810', 'Exynos 7420', 'Helio X25', '', 'A8X', '', ''],
    ['', '', '', '', '', '', 'Helio X23', '', '', '', ''],
    ['', '', '', '骁龙653', '', '', 'Helio X20', '', '', '', ''],
    ['', '', '', '', '', '', 'Helio P30', '', 'A8', '', ''],
    ...
    ['', '', '', '', '', '', '', '麒麟659', '', '', ''],
    ['', '', '', '骁龙626', '骁龙805', '', '', '麒麟650', '', '', ''],
    ['', '', '', '骁龙625', '骁龙801<br/>(MSM8x74AC)', 'Exynos 5430', '', '', '', 'Z3590', ''],
    ['', '', '', '', '骁龙801<br/>(MSM8x74AB)', 'Exynos 7870', '', '', '', 'Z3580', ''],
    ['', '', '', '', '骁龙801<br/>(MSM8x74AA)', 'Exynos 7580', 'MT6752/M', '', '', 'Z3570', ''],
